...
# Nick API Credits - This will print the remaining API credits in terminal or Python Console after conversion. I needed this badly and worked out a quick way of doing it.
